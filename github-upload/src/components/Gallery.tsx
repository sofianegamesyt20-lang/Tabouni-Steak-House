...
export default function Gallery() {
  ...
  const filters = [
    ...
    { id: 'dishes', name: t('gallery.filter.dishes') },
    { id: 'ambiance', name: t('gallery.filter.ambiance') },
    ...
    <section id="gallery" ref={sectionRef} className="py-20 bg-neutral-offwhite">
      <div className="container mx-auto px-4">
        <div className={`text-center mb-12 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
          <h2 className="text-5xl font-bold text-neutral-charcoal mb-4">{t('gallery.title')}</h2>
